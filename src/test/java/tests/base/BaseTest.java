...
//      capabilities.setCapability("videoName", format("%s.mp4", testCaseName));
        ...
        Configuration.baseUrl = System.getProperty("URL", PropertyReader.getProperty("url"));
//
...
//        options.addArguments("--headless");
        ...
        chromeOptions.addArguments("--user-data-dir=D:\\automationExcercise\\browser_profiles");
