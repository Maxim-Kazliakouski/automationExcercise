...
public class ProductsPageLocators {
    ...
    public static final SelenideElement SUBMIT_BUTTON = $(byId("button-review"));
    ...
    public static final String SUCCESS_CREATING_REVIEW_MESSAGE = "//div[@class='alert-success alert']//span";
}
